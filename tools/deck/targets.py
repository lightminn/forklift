...
ROWS = [
    ('양성 검출률', 100.0, 95.0, '%', '이상', 'dev 42 / 42 · eval 18 / 18', 100.0),
    ('위치 오차 p95', 8.17, 20.0, 'mm', '이하', 'dev 기준 · eval 5.98 mm', 22.0),
    ('방향 오차 p95', 0.053, 2.0, '°', '이하', 'dev 기준 · eval 0.026°', 2.2),
]
GREEN = (76, 205, 120)
...
def build():
    ...
    canvas, d, _ = R.titled((W, TOP + RH * len(ROWS) + 44),
                            ...
                            '실물 규격 100장면 · p95는 오차의 95 %가 이 값 이하라는 뜻')
    x0, x1 = 360, W - 300
