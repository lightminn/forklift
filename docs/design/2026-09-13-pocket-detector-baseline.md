...
작성일: 2026-09-13. 상태: **v2 초안 — Codex 교차검증(2026-09-13) 반영, 사용자 승인 대기.** 로드맵 M2([로드맵](../plans/2026-09-11-development-roadmap.md) §3 M2·§6)와 2026-09-13 사용자 확인(기하 기반 기준선 먼저, 초기 목표 p95 위치 ≤ 20 mm·yaw ≤ 2°·양성 검출률 ≥ 95 %, dev로만 튜닝·eval은 최종 보고, 첫 시연물은 포켓 경계·좌표 영상 + 장면별 오차표)을 구현 가능한 모듈로 구체화한다. 실물 센서·추적(M3)·주행은 범위가 아니다.
