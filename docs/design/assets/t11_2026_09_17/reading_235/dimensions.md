...
| O | 두 개구 각각의 순폭 (조건부) | 141 | CLI --opening-reading 235 mm × --scale 0.6; docs/decisions/0002-test-pallet-and-geometry-generality.md:195; docs/decisions/0002-test-pallet-and-geometry-generality.md:196 |
| B | 각 블록 폭 y = 깊이 x | 126 | (W − 2×O)/3; 같은 폭의 지지대 3개 가정; docs/decisions/0002-test-pallet-and-geometry-generality.md:195; docs/decisions/0002-test-pallet-and-geometry-generality.md:196 |
| BW | 하부 판재 각각의 폭 | 126 | B와 동일; src/forklift_core/perception/pallet_geometry.py:55 |
...
| BX | 블록 / 스트링거 x 중심 | -267, 0, 267 | [−(D−B)/2, 0, +(D−B)/2]; tools/build_pallet_model.py:34 |
| BY | 블록 / 하부 판재 y 중심 | -267, 0, 267 | [−(W−B)/2, 0, +(W−B)/2]; tools/build_pallet_model.py:34 |
...
| --- | --- | --- | --- |
| bottom_board_0 | 660, 126, 15 | 0, -267, 7.5 | size=(D,BW,DB); centre=(0,BY,DB/2); tools/build_pallet_model.py:34 |
| bottom_board_1 | 660, 126, 15 | 0, 0, 7.5 | size=(D,BW,DB); centre=(0,BY,DB/2); tools/build_pallet_model.py:34 |
| bottom_board_2 | 660, 126, 15 | 0, 267, 7.5 | size=(D,BW,DB); centre=(0,BY,DB/2); tools/build_pallet_model.py:34 |
| block_x0_y0 | 126, 126, 45 | -267, -267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x0_y1 | 126, 126, 45 | -267, 0, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x0_y2 | 126, 126, 45 | -267, 267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x1_y0 | 126, 126, 45 | 0, -267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x1_y1 | 126, 126, 45 | 0, 0, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x1_y2 | 126, 126, 45 | 0, 267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x2_y0 | 126, 126, 45 | 267, -267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x2_y1 | 126, 126, 45 | 267, 0, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| block_x2_y2 | 126, 126, 45 | 267, 267, 37.5 | size=(B,B,BH); centre=(BX,BY,BZ); tools/build_pallet_model.py:34 |
| stringer_0 | 126, 660, 15 | -267, 0, 67.5 | size=(B,W,ST); centre=(BX,0,DB+BH+ST/2); tools/build_pallet_model.py:34 |
| stringer_1 | 126, 660, 15 | 0, 0, 67.5 | size=(B,W,ST); centre=(BX,0,DB+BH+ST/2); tools/build_pallet_model.py:34 |
| stringer_2 | 126, 660, 15 | 267, 0, 67.5 | size=(B,W,ST); centre=(BX,0,DB+BH+ST/2); tools/build_pallet_model.py:34 |
...
| --- | --- | --- | --- | --- | --- |
| opening_width | 141 | [190, 230] | False | 49 | config/pallet_prior_t11_06.yaml:9–11 (opening_width_range) |
| centre_spacer | 126 | [65, 95] | False | 31 | config/pallet_prior_t11_06.yaml:12–14 (centre_spacer_range) |
