...
| EPAL 6 팔레트·도킹 | 형상 파일 하나에서 시뮬레이션 모델과 인식 prior를 생성하고 드리프트를 시험으로 막았다. 공식 EPAL 6 규격으로 지게차 포크가 좌우 77.5·147.5 mm 여유로 승강 없이 들어가며, 96프레임 도킹 미리보기의 전 구간 최소 간극 6 mm([기록](2026-09-13-epal6-pallet-and-docking.md)) | 접촉·적재·주행 제어, 실물 차체와 실물 팔레트. 포크 치수는 사진 비율 추정이고 블록 폭은 도면 측정 ±3 mm다. 합성 장면 100장은 아직 옛 형상이라 M2 평가는 EPAL 6으로 다시 받아야 한다 |
