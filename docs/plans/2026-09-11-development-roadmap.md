...
**총 15주 중 실질 개발 약 12주**라는 사용자 확인을 반영했다. 시험 주간은 개발 주차에서 제외하고 공휴일은 제외하지 않는다(2026-09-13 사용자 확인).

**달력 대응(2026-09-13 확정):** 학기 주차는 금요일 시작이며 8주차(10/23–10/29)가 중간고사, 16주차(12/18–12/21)가 기말고사다. 이 두 주만 빼고 개발한다. 아래 표의 개발 주차는 다음 달력 주에 대응한다. 마지막 15주차는 기말 전 예비 주로 남긴다.
